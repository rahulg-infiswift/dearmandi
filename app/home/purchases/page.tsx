...
export default function PurchasingSection() {
  const headers = ["Kisan Name", "Crop Name", "Quantity", "Total Weight", "Price"];

  return (
    <div className="flex min-h-screen">
      <Navbar />
      <div className="flex-1 p-4 ml-[16rem]"> {/* Adjust ml-[16rem] based on your Navbar's actual width */}
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full leading-normal">
            ...
            <tbody>
              <tr>
                <td colSpan={headers.length} className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
